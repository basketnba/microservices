package com.epam.training.microservices.service.state.machine.delivery.sm;

import com.epam.training.microservices.service.state.machine.delivery.action.OnCompleteDeliveryAction;
import com.epam.training.microservices.service.state.machine.delivery.action.OnRejectAction;
import com.epam.training.microservices.service.state.machine.delivery.action.OnStartDeliveryAction;
import com.epam.training.microservices.service.state.machine.delivery.model.DeliveryEvent;
import com.epam.training.microservices.service.state.machine.delivery.model.DeliveryState;
...
public class DeliveryStateMachineConfiguration extends
    EnumStateMachineConfigurerAdapter<DeliveryState, DeliveryEvent> {
      ...
      public void transition(Transition<DeliveryState, DeliveryEvent> transition) {
        System.out.println(String.format(
            ...
            Optional.ofNullable(transition.getSource())
                .map(State::getId)
                .orElse(DeliveryState.CONFIRMED),
