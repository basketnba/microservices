...
import com.epam.training.microservices.service.recipes.model.RecipeLine;
import com.epam.training.microservices.service.recipes.model.Recipient;
import com.epam.training.microservices.service.recipes.repository.DoctorRepository;
import com.epam.training.microservices.service.recipes.service.DrugServiceClient;
import com.epam.training.microservices.service.recipes.repository.RecipientRepository;
import com.epam.training.microservices.service.recipes.service.recipe.RecipeService;
    ...
    for (RecipeLoadModel recipeModel : model.getRecipes()) {
      ...
      final Set<RecipeLine> recipeLines = recipeModel.getContent().stream()
          .map(line -> {
            ...
            newLine.setDrugId(
                drugClient.getDrugIdByName(line.getDrug())
                    .orElseGet(() -> -1L)
            );
