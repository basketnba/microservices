...
public class RecipeRepositoryImpl extends BasicCrudRepository<Recipe, RecipeEntity, Long>
  ...
  @Override
  public Optional<Recipe> findRecipeByDoctorAndRecipientAndIssueDate(
      Doctor doctor,
      Recipient recipient,
      LocalDate issueDate) {
